<template>
  <div>
        ...
        <div class="hero-inner">
          <div class="hero-copy">
            ...
            <p class="hero-paragraph is-revealing">
              steht für Vendo Novum – Neue Werbung
            </p>
        ...
        <div class="features-inner section-inner has-top-divider">
          <div class="features-header text-center">
            <div class="container-sm">
              <h2 class="section-title mt-0">
                Neue Werbung und dafür stehen wir.
              </h2>
              <p class="section-paragraph mb-0">
                Eine neue Art der Konsumation von Werbung – seriös und simpel. Für den User bedeutet dies eine einfache Möglichkeit, schnell Geld zu verdienen. Für die Unternehmen bieten sich neue und unvergleichliche Chancen, die gewünschte Zielgruppe effizient und genau zu erreichen. Wie das genau funktionieren soll? Hier erfahrt ihr mehr.
              </p>
            </div>
          </div>
          <div class="features-wrap">
            <div class="feature is-revealing">
              <div class="feature-inner">
                <div class="feature-icon">
                  <img src="../static/images/feature-icon-01.svg"
                       alt="Feature 01" />
                </div>
            ...
            <div class="feature is-revealing">
              <div class="feature-inner">
                <div class="feature-icon">
                  <img src="../static/images/feature-icon-02.svg"
                       alt="Feature 02" />
                </div>
                <h4 class="feature-title">
                  Seriös
            ...
            <!-- <div class="feature is-revealing">
                <div class="feature-inner">
                    ...
                    <p class="text-sm">So easy, even your grandmother could use it</p>
                </div>
            </div> -->
            <div class="feature is-revealing">
              <div class="feature-inner">
                <div class="feature-icon">
                  <img src="../static/images/feature-icon-04.svg"
                       alt="Feature 04" />
                </div>
                <h4 class="feature-title">
                  Sicher
    ...
    <!--                        <div class="pricing-table-price"><span class="pricing-table-price-currency">$</span><span class="pricing-table-price-amount h1">29</span>/m</div>-->
    <!--                      </div>-->
